...
WebUI.clearText(findTestObject('Object Repository/Checkout_Page/txt_Username'))

// Step 2: Click "Place Order" button
WebUI.click(findTestObject('Object Repository/Checkout_Page/btn_PlaceOrder'))

// Step 3: Verify error message
WebUI.verifyElementVisible(findTestObject('Object Repository/Checkout_Page/span_UsenameErrorMessage'))